...
describe("computePinned", () => {
  it("should be 0 when there are no pinned pieces", () => {
    ...
    expect(computePinned(bitboards, C.WHITE)).toBe(0n);
    expect(computePinned(bitboards, C.BLACK)).toBe(0n);
  });
  ...
  it("detects piece pinned by a rook", () => {
    ...
    expect(computePinned(bitboards, C.WHITE)).toBe(1n << BigInt(27));
    expect(computePinned(bitboards, C.BLACK)).toBe(1n << BigInt(60));
  });
  ...
  it("detects piece pinned by a bishop", () => {
    ...
    expect(computePinned(bitboards, C.WHITE)).toBe(1n << BigInt(14));
    expect(computePinned(bitboards, C.BLACK)).toBe(1n << BigInt(50));
  });
  ...
  it("detects piece pinned by a queen (orthogonal)", () => {
    ...
    expect(computePinned(bitboards, C.WHITE)).toBe(1n << BigInt(6));
    expect(computePinned(bitboards, C.BLACK)).toBe(1n << BigInt(51));
  });
  ...
  it("detects piece pinned by a queen (diagonal)", () => {
    ...
    expect(computePinned(bitboards, C.WHITE)).toBe(1n << BigInt(45));
    expect(computePinned(bitboards, C.BLACK)).toBe(1n << BigInt(34));
  });
