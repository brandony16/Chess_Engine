import { popcount } from "../components/bitboardUtils/bbUtils";
import {
  bishopAttacks,
...
import { findRookCollision } from "../components/bitboardUtils/moveGeneration/magicBitboards/magicNumberRegen";
import {
  rookMagics,
  rookShifts,
} from "../components/bitboardUtils/moveGeneration/magicBitboards/magicNumbers";
import {
