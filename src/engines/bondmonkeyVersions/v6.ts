...
export class BondmonkeyV6 implements Bondmonkey {
  static readonly name = "BondmonkeyV6";
  static readonly description = "Searches capture sequences to completion";
