...
export class BondmonkeyV3 implements Bondmonkey {
  static readonly name = "BondmonkeyV3";
  static readonly description = "Performs a search up to a specified depth";
