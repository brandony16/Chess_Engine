...
/**
 * Evolution of minimaxV13 that adds SEE to move ordering
 */
export class MinimaxV14 implements Engine {
  ...
  #searchRoot(
    ...
    for (let i = 0; i < moveNum; i++) {
      scoreBuf[start + i] = scoreMoveWithSEE(
        moveBuf[start + i],
        pos,
        pos.searchPly,
        this.killerMoves,
        this.historyTable,
        this.evaluation.pieceWeights,
        firstToSearch,
      );
    }
