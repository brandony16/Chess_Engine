...
import { BattleModalStates, nameToType } from "../../../utilTypes.ts";
import { useGameStore } from "../../../gameStore.ts";

import Setting from "./Setting.jsx";
import Loading from "./Loading.jsx";
import FinalStats from "./FinalStats.jsx";

import "./BattleEngines.css";

const BattleEngines = () => {
  // Engine States
  const [engine1, setEngine1] = useState("BondMonkeyV6");
  const [depth1, setDepth1] = useState(5);
  const [engine2, setEngine2] = useState("BondMonkeyV6");
